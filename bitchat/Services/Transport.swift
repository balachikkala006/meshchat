...
protocol Transport: AnyObject {
    // Event sink
    var delegate: MeshChatDelegate? { get set }
    ...
    func sendFileBroadcast(_ packet: MeshChatFilePacket, transferId: String)
    func sendFilePrivate(_ packet: MeshChatFilePacket, to peerID: PeerID, transferId: String)
